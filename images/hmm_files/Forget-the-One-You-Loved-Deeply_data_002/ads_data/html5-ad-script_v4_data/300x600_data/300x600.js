...
lib.ssMetadata = [
		{name:"300x600_atlas_P_", frames: [[0,0,150,150],[152,0,150,150],[304,0,150,150],[0,152,150,150],[152,152,150,150],[304,152,150,150],[0,304,150,150],[152,304,150,150],[304,304,150,150],[0,456,150,150],[152,456,150,150],[304,456,150,150],[0,608,150,150],[152,608,150,150],[304,608,150,150],[0,760,150,150],[152,760,200,29]]}
];
...
(lib.overlay = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgY/AwcMAAAhg3MAx/AAAMAAABg3g");
	this.shape.setTransform(160,310);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.overlay, new cjs.Rectangle(0,0,320,620), null);
...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.Text = new cjs.Text("Try Azure free Try Azure fre", "14px 'Segoe Pro Semibold'", "#FFFFFF");
	this.Text.name = "Text";
	this.Text.textAlign = "center";
	this.Text.lineHeight = 19;
	this.Text.lineWidth = 179;
	this.Text.parent = this;
	this.Text.setTransform(92.55,2);

	this.timeline.addTween(cjs.Tween.get(this.Text).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(1,0,183.1,22.9), null);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,0.715,0.7155);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(0,0,143,20.8), null);
...
(lib._3dPlainMov = function(mode,startPosition,loop) {
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(219.7,152.4,0.5096,0.4412,0,164.9698,27.8112,1.4,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:1.2,regY:0.2,scaleX:0.5103,scaleY:0.3619,skewX:193.7808,skewY:27.8225,x:254.25,y:196.75},74,cjs.Ease.quadInOut).to({regY:0.1,scaleX:0.5096,scaleY:0.3817,skewX:187.2716,skewY:27.8112,x:244.4,y:185.65},37,cjs.Ease.quadInOut).to({regY:0.2,scaleX:0.5103,scaleY:0.3619,skewX:193.7808,skewY:27.8225,x:254.25,y:196.75},34,cjs.Ease.quadInOut).wait(1));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(197.2,34.45,1.4736,1.4736,0,0,0,11,10.5);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Av7DDIAAmFIf3AAIAAGFg");
	this.shape.setTransform(102,19.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(0,0,204,39), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function loadData() {
			...
			var contentD = [
				{
					"name": "Generic",
					"description": "Build AI apps with just a few lines of code",//"Manage your app with 12 months of free services including compute, storage, and database",//"Code, experiment, and build your next great web app",
					"passthroughfield1": "Essayez Azure gratuitment",//Testez Azure gratuitement//Try Azure free//Teste o Azure gratuitamente//Попробуйте Azure бесплатно
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(80,80,80,0)").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	...
	this.logo.setTransform(112.5,51.3,1,1,0,0,0,71.5,10.3);
	...
	this.txtCta.setTransform(41,331);
	...
	this.cta.setTransform(41.2,324.4,1,1,0,0,0,0.2,0.4);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(72));

	// headlineText
	this.headlineText = new cjs.Text("Build intelligent apps faster with analytics and built-in AI with analytics and ", "30px 'Segoe Pro Semibold'", "#505050");
	this.headlineText.name = "headlineText";
	this.headlineText.lineHeight = 35;
	this.headlineText.lineWidth = 231;
	this.headlineText.parent = this;
	this.headlineText.setTransform(37,149);
	...
	this.Serverless.setTransform(141,484,0.2206,0.2204,0,0,0,386.2,394.8);
	...
	this.DataBrick.setTransform(140.3,483.05,0.2377,0.2375,0,0,0,610.8,450.9);
	...
	this.Square.setTransform(146.95,432.4,0.1667,0.1666,0,0,0,602.4,144.1);
	...
	this.Cube.setTransform(313.3,265.2,1.3,1.3,0,0,0,241,204);
	...
	this.Bar.setTransform(110,530,1.12,1.12,0,0,0,199.9,188);
	...
	this.Triangle.setTransform(243.9,564.25,1.5,1.5,0,0,0,299.9,250.2);
	...
	this.Arrows.setTransform(256.55,578.35,1.5,1.5,0,0,0,300,250.2);
	...
	this.Code.setTransform(147.55,496.05,1.2,1.2,0,0,0,245,194.1);
	...
	this.Chat.setTransform(149.1,510,1.3,1.3,0,0,0,232,199.1);
	...
	this.Wave.setTransform(300,550.2,1,1,0,0,0,300,250.2);
...
p.nominalBounds = new cjs.Rectangle(-491,71,1078.4,561);
// library properties:
lib.properties = {
